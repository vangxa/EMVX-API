<?php
/**
Title: View unopens for a specific campaign.

Description: View all unopens for a specific campaign. You will be able to see the email address of each unopen, much like on the Campaign Reports page.
...
Parameters (* denotes requirement):
{
	...
	[*api_action] => campaign_report_unopen_list
	[*api_output] => xml, json, or serialize
	[*campaignid] => ID of the campaign you wish to see unopens for
	[*messageid] => Message ID associated with the above campaign
}
